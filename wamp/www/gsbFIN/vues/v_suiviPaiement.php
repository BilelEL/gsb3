        ...
        <table class="suivie">
            ...
            <tr>
                ...
                <form action="index.php?uc=suiviPaiement&action=suivreLePaiement" method="POST">
                    ...
                    <td><a target="_blank" href="index.php?uc=suiviPaiement&action=genererPDF&i=<?php echo($idVisiteur) ?>&mois=<?php echo($mois) ?>"></span></button><img src='./images/PDF_icon.jpg'></a></td>
